...
class MonoPackageManager_Resources {
	public static final String[] Assemblies = new String[]{
		/* We need to ensure that "Xamarin.Forms.Save.Open.PDF.Android.dll" comes first in this list. */
		"Xamarin.Forms.Save.Open.PDF.Android.dll",
		"FormsViewGroup.dll",
		...
		"Xamarin.Forms.Save.Open.PDF.dll",
